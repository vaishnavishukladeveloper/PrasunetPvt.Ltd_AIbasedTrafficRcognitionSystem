...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\lenovo\PycharmProjects\traffic_sign_recognition\new project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\lenovo\PycharmProjects\traffic_sign_recognition\new project\Scripts\deactivate.nu'
